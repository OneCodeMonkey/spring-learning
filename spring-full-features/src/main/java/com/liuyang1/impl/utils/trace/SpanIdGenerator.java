...
public class SpanIdGenerator {
    ...
    static String getTraceId() {
        ...
        String var10000 = handleFormat(Long.toHexString(traceIdpart1), 16);
        return var10000 + handleFormat(Long.toHexString(traceIdpart2), 16);
    }
    ...
    private static String handleFormat(String value, int digit) {
        if (value == null) {
            ...
            while (valueBuilder.length() < digit) {
